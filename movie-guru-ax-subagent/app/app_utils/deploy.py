...
@click.option(
    "--description",
    default="An agent that analyzes conversation sentiment to generate a customer satisfaction metric.",
...
@click.option(
    "--service-account",
    default=f"movie-guru-chat-server-sa@{project_id}.iam.gserviceaccount.com",
...
@click.option(
    "--cpu",
    default="1",
    help="CPU limit (default: 1)",
)
@click.option(
    "--memory",
    default="2Gi",
    help="Memory limit (default: 2Gi)",
)
@click.option(
